...
//             $('input#id_captcha_0').attr("value",data.key);
//         }
//     });
// }
...
$(function() {
    ...
    //注册刷新验证码点击事件  前面必须加一个form，否则会报jQuery无效错误，后续选择加上img
    $('form#email_register_form  img.captcha-refresh').click({'form_id':'email_register_form'},refresh_captcha);
    $('form#email_register_form  img.captcha').click({'form_id':'email_register_form'},refresh_captcha);
    $('form#mobile_register_form  .captcha').click({'form_id':'jsRefreshCode'},refresh_captcha);
    $('#changeCode').click({'form_id':'jsRefreshCode'},refresh_captcha);
    $('form#jsFindPwdForm  img.captcha-refresh').click({'form_id':'jsFindPwdForm'},refresh_captcha);
    $('form#jsFindPwdForm  img.captcha').click({'form_id':'jsFindPwdForm'},refresh_captcha);
    $('form#jsChangePhoneForm  img.captcha').click({'form_id':'jsChangePhoneForm'},refresh_captcha);
